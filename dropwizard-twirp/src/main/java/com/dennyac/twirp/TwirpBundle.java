 ...
 *
 * <p>After installation, any resource class generated by {@code jaxrs-twirp-protoc}
 ...
 * }</pre>
 *
 * <p>If code generation uses a custom {@code prefix}, configure the same value
 * with {@link Builder#pathPrefix(String)} so only failures beneath that path are
 * rendered as Twirp {@code bad_route} responses.
 *
...
public class TwirpBundle<C extends Configuration> implements ConfiguredBundle<C> {
    ...
    public static final class Builder {
        ...
        /**
         * Set the Twirp URL prefix used to identify routing failures. This must
        ...
        /**
         * Configure multiple Twirp URL prefixes when one application serves
